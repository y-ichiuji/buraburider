/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 465a9bf9d20964f7c6390b49febb4a55)
// Runtime types generated with workerd@1.20260730.1 2026-06-14 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	CACHE: KVNamespace;
	BURABURIDER_DB: D1Database;
	AI: Ai;
	MAPBOX_SECRET_TOKEN: string;
	MAPBOX_PUBLIC_TOKEN: string;
	RideSession: DurableObjectNamespace<import("./src/index").RideSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RideSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAPBOX_SECRET_TOKEN" | "MAPBOX_PUBLIC_TOKEN">> {}
}
